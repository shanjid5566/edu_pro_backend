...
class StudentResultsService {
        ...
        try {
            ...
            return {
                ...
                data: {
                    ...
                    averageGrade: (0, gradeUtils_js_1.calculateGrade)(averagePercentage),
    ...
    async getSubjectPerformance(userId) {
        try {
            ...
            return {
                success: true,
                data: subjectPerformance.sort((a, b) => b.averagePercentage - a.averagePercentage),
            };
        }
        catch (error) {
    ...
    async getClassComparison(userId) {
        try {
            ...
            const studentResults = await prisma_js_1.prisma.examResult.findMany({
                where: { studentId },
                select: {
                    marksObtained: true,
                    exam: {
            ...
            const studentPercentage = studentTotalMarksCount > 0
                ...
                : 0;
            // Get class average
            const classResults = await prisma_js_1.prisma.examResult.findMany({
                where: {
            ...
            const classAverage = totalStudents > 0 ? Math.round(classTotal / totalStudents) : 0;
            ...
            return {
                ...
                data: {
                    ...
                    studentRank,
                    totalStudents,
                    percentileRank: totalStudents > 0
                        ? Math.round(((totalStudents - studentsBetterThanMe) / totalStudents) * 100)
                        : 0,
                },
            };
        }
...
exports.default = new StudentResultsService();
