...
export type GetNoticeAggregateType<T extends NoticeAggregateArgs> = {
    [P in keyof T & keyof AggregateNotice]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateNotice[P]> : Prisma.GetScalarType<T[P], AggregateNotice[P]>;
};
...
type GetNoticeGroupByPayload<T extends NoticeGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<NoticeGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof NoticeGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], NoticeGroupByOutputType[P]> : Prisma.GetScalarType<T[P], NoticeGroupByOutputType[P]>;
}>>;
export type NoticeWhereInput = {
    ...
    priority?: Prisma.StringFilter<"Notice"> | string;
...
export type NoticeScalarWhereWithAggregatesInput = {
    ...
    priority?: Prisma.StringWithAggregatesFilter<"Notice"> | string;
...
export type NoticeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "message" | "category" | "priority" | "pinned" | "createdBy" | "createdAt", ExtArgs["result"]["notice"]>;
...
export type NoticeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<NoticeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NoticeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends NoticeCountArgs>(args?: Prisma.Subset<T, NoticeCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], NoticeCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends NoticeGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, NoticeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNoticeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface NoticeFieldRefs {
    ...
    readonly priority: Prisma.FieldRef<"Notice", 'String'>;
