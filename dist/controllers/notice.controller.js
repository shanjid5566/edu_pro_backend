...
export class NoticeController {
    ...
    async getAllNotices(req, res) {
        try {
            ...
            const result = await noticeService.getAllNotices(page, pageSize, category, sortBy);
            res.json({
                success: true,
    ...
    async getNoticesByCategory(req, res) {
        try {
            ...
            const result = await noticeService.getNoticesByCategory(category, page, pageSize);
            res.json({
                success: true,
    ...
    async createNotice(req, res) {
        try {
            ...
            const notice = await noticeService.createNotice({ title, message, category, priority, pinned }, userId);
            res.status(201).json({
                success: true,
