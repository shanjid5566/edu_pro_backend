...
router.put(
  ...
  settingController.updateGeneralSettings.bind(settingController)
);
...
router.get(
  "/user/preferences",
  verifyToken,
  settingController.getUserPreferences.bind(settingController)
);
...
router.put(
  ...
  handleValidationErrors,
  settingController.updateUserPreferences.bind(settingController)
);
...
router.get(
  "/user/profile",
  verifyToken,
  settingController.getUserProfile.bind(settingController)
);
...
router.put(
  ...
  handleValidationErrors,
  settingController.updateUserProfile.bind(settingController)
);
...
router.put(
  ...
  handleValidationErrors,
  settingController.updateNotificationPreferences.bind(settingController)
);
...
router.put(
  ...
  handleValidationErrors,
  settingController.updateAppearanceSettings.bind(settingController)
);
...
router.get(
  "/health/check",
  verifyToken,
  settingController.getSystemStatus.bind(settingController)
);
