...
router.get(
  ...
  attendanceController.getDailyStats.bind(attendanceController)
);
...
router.get(
  ...
  handleValidationErrors,
  attendanceController.getOverview.bind(attendanceController)
);
...
router.get(
  ...
  handleValidationErrors,
  attendanceController.getClassWiseAttendance.bind(attendanceController)
);
...
router.get(
  ...
  handleValidationErrors,
  attendanceController.getStudentPercentage.bind(attendanceController)
);
...
router.post(
  ...
  handleValidationErrors,
  attendanceController.bulkMarkAttendance.bind(attendanceController)
);
