...
class AdminClassService {
   ...
   */
  async getAllClasses(options: ClassListOptions) {
    try {
   ...
   * Search classes
   */
  async searchClasses(query: string, limit: number = 10) {
    try {
   ...
   */
  async exportClassesToCSV(options: ClassListOptions) {
    try {
